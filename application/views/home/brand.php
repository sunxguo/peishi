			...
			<div class="heard_warp clearfix">
				...
				<div class="header_bar HeaderBar">
					<ul>
						...
						<li><a class="this" href="/home/brand" style="color:#222222;">品牌活动</a></li>
...
<div class="blog_main">
	<div class="blog_content_1">
		...
		<img style="display: inline;" src="<?php echo $dingbu[0]->thumbnail;?>" class="lazy" width="100%" height="700px">
		<?php endif;?>
	</div>
