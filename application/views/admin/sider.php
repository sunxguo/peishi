	...
	<ul class="nav">
		...
		<li class="has-sub">
			...
			<ul class="nav <?php echo array_key_exists('content',$sider)?'':'km-hide';?>">
				...
				<!-- <li><a href="/admin/problem" class="<?php echo array_key_exists('problem',$sider)?'active':'';?>">常见问题</a></li> -->
				<!-- <li><a href="/admin/contactus" class="<?php echo array_key_exists('contactus',$sider)?'active':'';?>">联系我们</a></li> -->
			</ul>
		</li>
		<?php /*?>
		<li>
